...
const GlobalStyle = createGlobalStyle`
  * {
    ...
    font-family: "Twemoji Mozilla", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
